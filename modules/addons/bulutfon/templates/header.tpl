...
{if !$smarty.get.userid}
    <div class="col-md-2">
        <ul class="side-menu">
            ...
            <li><a href="addonmodules.php?module=bulutfon&action=sms" {if $smarty.get.tab eq 'sms-templates'} class="active" {/if}><i class="fa fa-pencil-square-o"></i>SMS Şablonları</a></li>
