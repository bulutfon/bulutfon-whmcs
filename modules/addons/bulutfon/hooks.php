...
add_hook('AdminAreaFooterOutput', 10, function ($vars) {
    return "<script src=\"{$vars['WEB_ROOT']}/modules/addons/bulutfon/assets/js/axios.min.js\"></script>\n<script src=\"{$vars['WEB_ROOT']}/modules/addons/bulutfon/assets/js/mixins/paginator.js\"></script>\n<script src=\"{$vars['WEB_ROOT']}/modules/addons/bulutfon/assets/js/vue.js\"></script>\n<script src='{$vars['WEB_ROOT']}/modules/addons/bulutfon/assets/js/bulutfon.js'></script>\n";
});
